...
# フォルダ取得
root_paths = sorted(glob("data/artifact/result/**"))
...
for root_path in tqdm(root_paths):
    ...
    # 図に出力
    display_artifact(train_x, train_nums, root_path + "/train.png")
    # display_artifact(val_x, val_nums, root_path + "/val.png")
    # display_artifact(test_x, test_nums, root_path + "/test.png")
